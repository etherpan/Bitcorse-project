...
contract Mcorse is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 MCORSEs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Mcorse", "MCORSE") {
        _mint(msg.sender, 1 ether); // mint 1 Mcorse for initial pools deployment
