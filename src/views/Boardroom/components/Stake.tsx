...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(bombFinance.MCORSE, bombFinance.contracts.Boardroom.address);
  const tokenBalance = useTokenBalance(bombFinance.MCORSE);
  const stakedBalance = useStakedBalanceOnBoardroom();
  const {from, to} = useUnstakeTimerBoardroom();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('MCORSE', bombFinance.MCORSE);
        ...
        <CardContent>
          <StyledCardContentInner>
            <StyledCardHeader>
              ...
              <Label text={'MCORSE Staked'} variant="yellow" />
            </StyledCardHeader>
            <StyledCardActions>
              {approveStatus !== ApprovalState.APPROVED ? (
                <Button
                  disabled={approveStatus !== ApprovalState.NOT_APPROVED}
                  className={approveStatus == ApprovalState.NOT_APPROVED ? 'shinyButtonSecondary' : 'shinyButtonDisabled'}
