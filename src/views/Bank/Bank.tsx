...
const Bank: React.FC = () => {
  ...
  let vaultUrl: string;
  if (bank.depositTokenName.includes('BCE')) {
    vaultUrl = 'https://www.bomb.farm/#/bsc/vault/bomb-bomb-btcb';
  } else {
    vaultUrl = 'https://www.bomb.farm/#/bsc/vault/bomb-mcorse-wbnb';
...
const LPTokenHelpText: React.FC<{bank: BankEntity}> = ({bank}) => {
  ...
  const bombAddr = bombFinance.BCE.address;
  const bulshareAddr = bombFinance.MCORSE.address;

  let pairName: string;
  let uniswapUrl: string;
 // let vaultUrl: string;
  if (!bank.depositTokenName.includes('MCORSE')) {
    pairName = 'BCE-BNB pair';
    uniswapUrl = 'https://pancakeswap.finance/add/BNB/' + bombAddr;
 //   vaultUrl = 'https://www.bomb.farm/#/bsc/vault/bomb-bomb-btcb';
  } else {
    pairName = 'MCORSE-BNB pair';
    uniswapUrl = 'https://pancakeswap.finance/add/BNB/' + bulshareAddr;
 //   vaultUrl = 'https://www.bomb.farm/#/bsc/vault/bomb-mcorse-bnb';
