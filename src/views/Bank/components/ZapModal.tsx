  ...
  return (
    <Modal>
      ...
      <Select onChange={handleChangeAsset} style={{color: '#2c2560'}} labelId="label" id="select" value={zappingToken}>
        ...
        <StyledMenuItem value={DSHARE_TICKER}>MCORSE</StyledMenuItem>
      ...
      <StyledDescriptionText>
        {' '}
        ({Number(estimate.token0)} {tokenName.startsWith(DSHARE_TICKER) ? DSHARE_TICKER : BNB_TICKER} /{' '}
        {Number(estimate.token1)} {tokenName.startsWith(DSHARE_TICKER) ? BNB_TICKER : DSHARE_TICKER}){' '}
      </StyledDescriptionText>
      <ModalActions>
        <Button
          color="primary"
